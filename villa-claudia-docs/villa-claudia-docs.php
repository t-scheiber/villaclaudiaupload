...
class Villa_Claudia_Docs {
    ...
    public function display_documents_meta_box($post) {
        ...
        echo '<table class="widefat" style="width: 100%; border-collapse: collapse; border: 1px solid #4d4d4d;">';
        echo '<thead><tr>';
        echo '<th style="border: 1px solid #4d4d4d; padding: 12px; text-align: left;">Traveler</th>';
        echo '<th style="border: 1px solid #4d4d4d; padding: 12px; text-align: left;">Document Type</th>';
        echo '<th style="border: 1px solid #4d4d4d; padding: 12px; text-align: left;">Document Number</th>';
        echo '<th style="border: 1px solid #4d4d4d; padding: 12px; text-align: left;">Filename</th>';
        echo '<th style="border: 1px solid #4d4d4d; padding: 12px; text-align: left;">Uploaded</th>';
        echo '</tr></thead>';
        echo '<tbody>';
        
        foreach ($documents as $doc) {
            echo '<tr>';
            echo '<td style="border: 1px solid #4d4d4d; padding: 12px; text-align: left;">' . esc_html($doc['traveler_name']) . '</td>';
            echo '<td style="border: 1px solid #4d4d4d; padding: 12px; text-align: left;">' . esc_html($doc['document_type']) . '</td>';
            echo '<td style="border: 1px solid #4d4d4d; padding: 12px; text-align: left;">' . esc_html($doc['document_number']) . '</td>';
            echo '<td style="border: 1px solid #4d4d4d; padding: 12px; text-align: left;">' . esc_html($doc['original_name']) . '</td>';
            echo '<td style="border: 1px solid #4d4d4d; padding: 12px; text-align: left;">' . esc_html($doc['uploaded_at']) . '</td>';
            echo '</tr>';
        }
